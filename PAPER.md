...
The following documents actual test runs from the live Game-Builder-Free Space. Only runs with recorded screenshots or video are included.
...
<img width="811" height="442" alt="Screenshot 2026-05-13 at 10 32 46 AM" src="https://github.com/user-attachments/assets/c63b8083-6877-4065-9499-7a0474c1487d" />


| Field | Details |
|---|---|
| **Theme** | Ancient Egyptian tomb raid with cursed mummies |
| **Mode** | Top-Down Shooter |
| **Sprites Generated** | 3 FLUX sprites — player, background, enemy |
| **Game Launched** | ✅ Yes |
| **What Worked** | Background rendered correctly — Egyptian desert ruins, atmospheric. Enemies visible falling from top. Score and health HUD displayed correctly. |
| **What Failed** | Player invisible on screen. Grey background box visible around character sprites. Enemy sprites front-facing not overhead view. |
| **What I Learned** | Background generation is the most reliable part of the pipeline. Character sprite perspective and background removal both need further work. |
...
| **Mode** | Top-Down Shooter |
| **Sprites Generated** | Fallback SVG placeholders — FLUX quota exhausted / wrong provider |
| **Game Launched** | ✅ Yes |
| **What Worked** | Game structure launched. Score and health HUD visible. |
| **What Failed** | All sprites showed as coloured boxes with text labels ("backgr", "player", "enemy"). Background not filling canvas — SVG tiling visible. Player not visible. |
| **What I Learned** | Silent fallback hid the real error. Making FLUX errors visible in the status message was essential for diagnosis. |

---

**Test 3 — Deep Space Mining Station, Enemies Approach Player + Escalating Difficulty (Top-Down Shooter)**

[Test 3 Screenshot — add image here]

| Field | Details |
|---|---|
| **Theme** | Deep space asteroid mining station — lone space marine in hazmat suit defending from alien parasites that move toward the player, spawning more frequently and moving faster over time |
| **Mode** | Top-Down Shooter |
